...
<%--			   静态包含登录成功之后的菜单--%>
		...
		<div class="login_banners">
			...
			<div id="l_content">
				<span class="login_word" >我的主页</span>
					<br/>
				<hr/>
		...
		<%--		<div id="main">--%>
<%--		--%>
<%--&lt;%&ndash;			<h1>欢迎回来 <a href="index.jsp">转到主页</a></h1>&ndash;%&gt;--%>
<%--&lt;%&ndash;			<div class="b_list" align="center">&ndash;%&gt;--%>
<%--				<div class="img_div">--%>
<%--					<img class="book_img" alt="" src="static/img/kobe.jpeg" />--%>
<%--				</div>--%>
<%--				<div class="book_info">--%>
<%--					<div class="book_name">--%>
<%--						<span class="sp1">用户id:</span>--%>
